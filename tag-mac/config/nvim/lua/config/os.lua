...
vim.keymap.set("n", "<c-8>", function()
    ...
    local url = string.format("https://search.brave.com/search?q=%s+%s&source=desktop", filetype, word)
...
vim.keymap.set("v", "<c-8>", function()
    ...
    local url = string.format("https://search.brave.com/search?q=%s+%s&source=desktop", filetype, selection)
