...
- Voice and register per `~/.claude/docs/david-style.md`; PR-specific formatting (review tags, template structure) per the pr-comms output style (`~/.claude/output-styles/pr-comms.md`)
