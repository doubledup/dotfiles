...
- Bias toward concise: cover the key details (root cause, what changed, testing) and cut the rest.
  Omit what is always implicit (e.g. that merged IaC deploys per environment via CI). Aim for a
  screenful.
