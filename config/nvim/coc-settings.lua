...
keyset("n", "<c-f>", string.format("coc#float#has_scroll() ? coc#float#scroll(1, %d) : '<c-f>'", scroll_length), opts)
keyset("n", "<c-b>", string.format("coc#float#has_scroll() ? coc#float#scroll(0, %d) : '<c-b>'", scroll_length), opts)
keyset(
    "i",
    "<c-f>",
    string.format(
        "coc#float#has_scroll() ? '<c-r>=coc#float#scroll(1, %d)<cr>' : '<right>'",
        scroll_length,
        scroll_length
    ),
    opts
...
keyset(
    ...
    "<c-b>",
    string.format(
        "coc#float#has_scroll() ? '<c-r>=coc#float#scroll(0, %d)<cr>' : '<left>'",
        scroll_length,
        scroll_length
    ),
    opts
...
keyset(
    "v",
    "<c-f>",
    string.format("coc#float#has_scroll() ? coc#float#scroll(1, %d) : '<c-f>'", scroll_length, scroll_length),
    opts
)
keyset(
    "v",
    "<c-b>",
    string.format("coc#float#has_scroll() ? coc#float#scroll(0, %d) : '<c-b>'", scroll_length, scroll_length),
    opts
)
